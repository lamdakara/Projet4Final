    ...
    public function index(Request $request)
    {
        ...
        if ($request->get('email')) {
            ...
            if ($user) {
                ...
                $mail = new Mail();
                $mail->send($user->getEmail(), $user->getFirstname() . ' ' . $user->getLastname(), 'Réinitialiser votre mot de passe sur le site Lili Giroud - massages madérothérapeutique', $content);
